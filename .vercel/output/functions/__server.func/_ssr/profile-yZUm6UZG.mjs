...
import { F as CloudOff, g as Plus, o as Trash2 } from "../_libs/lucide-react.mjs";
import { t as AppShell } from "./app-shell-B3YczGC1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/profile-yZUm6UZG.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `absolute top-0.5 left-0.5 size-6 rounded-full bg-background shadow transition-transform ${simulateOffline ? "translate-x-5" : "translate-x-0"}` })
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Emergency contacts" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									onClick: addContact,
							...
							draft.emergencyContacts.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-sm text-muted-foreground",
								children: "No contacts yet."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "space-y-3",
								children: draft.emergencyContacts.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
