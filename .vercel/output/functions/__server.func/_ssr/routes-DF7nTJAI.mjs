...
import { A as FileText, B as ChevronRight, F as CloudOff, H as Check, K as Activity, R as CircleCheck, _ as Pill, a as TriangleAlert, b as Mic, l as Siren, m as QrCode, s as Stethoscope, u as ShieldCheck, y as Network } from "../_libs/lucide-react.mjs";
import { t as AppShell } from "./app-shell-B3YczGC1.mjs";
import { t as motion } from "../_libs/framer-motion.mjs";
import { t as AiOrb } from "./ai-orb-CbPIJWSf.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DF7nTJAI.js
...
function Home() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppShell, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -top-20 -right-20 size-64 rounded-full bg-white/10 blur-3xl" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -bottom-16 -left-12 size-48 rounded-full bg-white/10 blur-3xl" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AiOrb, { size: 88 })]
				}),
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloudOff, { className: "size-5" })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex-1 min-w-0",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-3.5 text-primary shrink-0" }), f]
				}, f))
			})]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-baseline justify-between mb-3",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Today's snapshot" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SnapshotCard, {
					to: "/emergency",
					icon: profileReady ? ShieldCheck : TriangleAlert,
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "size-3.5 text-success" }), " on track"]
					})]
				})
			]
		}),
		!profileReady && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			to: "/profile",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "size-5 text-destructive" })
			]
		})
	] });
}
